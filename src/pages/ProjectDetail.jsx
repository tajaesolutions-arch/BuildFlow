      ...
      {loading ? <p>Loading project…</p> : bundle ? (
        <div className="page-stack">
          ...
          <section className="dashboard-grid">
            ...
            <article className="card"><p className="eyebrow">Safe placeholders</p><h2>Project tools</h2><div className="chip-list muted"><span>Budget summary placeholder</span><Link className="secondary-button" to={`/projects/${id}/inspections`}>Inspections</Link><Link className="secondary-button" to={`/projects/${id}/punch-list`}>Punch list</Link><span>Documents placeholder</span><span>Reports placeholder</span><span>AI placeholder</span></div><p>Quality control is active in Phase 3. Financials, documents, reports, and AI remain deferred.</p></article>
          </section>
